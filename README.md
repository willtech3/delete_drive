...
Lines 52-53 of `del.py` are where the script discriminates on what types of files to delete. Feel free to modify those lines to delete the files that you deem necessary. You can also just delete them and unindent the below lines if you want to delete everything.
